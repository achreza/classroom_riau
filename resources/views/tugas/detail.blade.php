            ...
            <div class="header-tugas">
                <div class="judul-tugas-group d-flex justify-content-between">
                    <div>
                        ...
                        <small class="text-muted">Deadline : {{ $tugas->tgl_mulai }},
                            {{ $tugas->tgl_akhir }}</small>
                    </div>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modalTugas"
                                    onclick="prefillUpdateForm('{{ $tugas->id }}', '{{ $tugas->nama_tugas }}', '{{ $tugas->deskripsi }}', '{{ $tugas->tgl_mulai }}','{{ $tugas->tgl_akhir }}','{{ $tugas->file }}')">
                                    Edit tugas</a></li>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body demo-vertical-spacing demo-only-element">
                    <form id="formUpdateTugas" method="POST" enctype="multipart/form-data">
                        @csrf
