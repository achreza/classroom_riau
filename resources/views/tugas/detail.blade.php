...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-pengumpulan-tab" data-bs-toggle="pill"
                        ...
                        aria-selected="false">Pengumpulan Tugas</button>
                </li>
            </ul>
                                                ...
                                                <div class="card-body">
                                                    <div class="card-pengumpulan-header d-flex justify-content-end">
                                                        ...
                                                        <a href="{{ route('pengumpulan.destroy', $pengumpulan->id) }}"
                                                            ...
                                                            data-confirm-delete="true">Batalkan Pengumpulan</a>
                                                    </div>
                                                    <h6>Nilai</h6>
                                                    ...
                                                    <a class="btn btn-primary mt-2 "
                                                        ...
                                                        <img class="tugas-setting-logo me-2"
                                                            src="{{ asset('image/tugas.svg') }}" alt="">
                                                        Download File
                                                    </a>
                                                </div>
                                            </div>
            ...
            {{-- Modal Edit --}}
            <div class="modal fade" id="modalTugas" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body demo-vertical-spacing demo-only-element">
                            <form id="formUpdateTugas" action="{{ route('tugas.update', ['id' => $tugas->id]) }}"
                                ...
                                <div class="form-password-toggle">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="namaTugas"
                                            ...
                                            name="nama_tugas" value="{{ $tugas->nama_tugas }}">
                                    </div>
                                </div>
                                <div class="form-password-toggle">
                                ...
                                <div class="form-password-toggle">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="pertemuan"
                                            placeholder="Pertemuan Ke-" aria-describedby="basic-default-password2"
                                            name="pertemuan" value="{{ $tugas->pertemuan }}">
                                    </div>
                                </div>
            ...
            <!-- Modal Penilaian -->
            <div class="modal fade" id="modalPenilaian" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
