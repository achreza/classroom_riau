        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-4 offset-lg-4">
                    <h3 class="text-center">Akun anda belum aktif, silahkan hubungi admin untuk informasi lebih lanjut</h3>
                </div>
            </div>
        </div>
    @elseif($status == 1)
                        ...
                        <table id="tableUser">
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="7"></td>
                                    <td>
                                        <button type="button" class="btn btn-primary" id="bulkActivate">UBAH STATUS
                                            AKTIF</button>
                                    </td>
                                </tr>
                            </tfoot>
